  ...
  subroutine initonegrid_usr(ixGmin1,ixGmax1,ixmin1,ixmax1,w,x)
    ...
    select case(iprob)
     ...
     case(21)
       ...
       byright  = -1.0d0
       bzright  = zero
       pright   = (mhd_gamma-one)*(0.88125d0-half*(bx**2+byright**2+&
          bzright**2))
    ...
    where(x(ixGmin1:ixGmax1,1)<=slocx1)
       w(ixGmin1:ixGmax1,rho_)     = rholeft
       w(ixGmin1:ixGmax1,mom(1))   = vleft(1)
       w(ixGmin1:ixGmax1,mom(2))   = vleft(2)
       w(ixGmin1:ixGmax1,mom(3))   = vleft(3)
       w(ixGmin1:ixGmax1,p_ )      = pleft
       w(ixGmin1:ixGmax1,mag(1) )  = bx
       w(ixGmin1:ixGmax1,mag(2) )  = byleft
       w(ixGmin1:ixGmax1,mag(3) )  = bzleft
    elsewhere
       w(ixGmin1:ixGmax1,rho_)     = rhoright
       w(ixGmin1:ixGmax1,mom(1))   = vright(1)
       w(ixGmin1:ixGmax1,mom(2))   = vright(2)
       w(ixGmin1:ixGmax1,mom(3))   = vright(3)
       w(ixGmin1:ixGmax1,p_  )     = pright
       w(ixGmin1:ixGmax1,mag(1) )  = bx
       w(ixGmin1:ixGmax1,mag(2) )  = byright
       w(ixGmin1:ixGmax1,mag(3) )  = bzright
    endwhere
